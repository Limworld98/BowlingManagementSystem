...
class ControlDesk extends Thread {
	...
	private ControlDeskEventPublisher controlDeskEventPublisher;
	...
	public ControlDesk(int numLanes) {
		...
		controlDeskEventPublisher = new ControlDeskEventPublisher();
	...
	public void assignLane() {
		...
		controlDeskEventPublisher.publish((getPartyQueue()));
	}
	...
	public void addPartyQueue(Vector partyNicks) {
		partyQueue.add(new Party(partyNicks));
		controlDeskEventPublisher.publish((getPartyQueue()));
	}
	...
	public void subscribe(ControlDeskObserver adding) {
		controlDeskEventPublisher.subscribe(adding);
	}
